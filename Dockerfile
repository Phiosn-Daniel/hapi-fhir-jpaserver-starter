...
ENTRYPOINT ["java", "--class-path", "/app/main.war", "-XX:MaxRAMPercentage=70.0","-Dloader.path=main.war!/WEB-INF/classes/,main.war!/WEB-INF/,/app/extra-classes", "org.springframework.boot.loader.PropertiesLauncher"]
